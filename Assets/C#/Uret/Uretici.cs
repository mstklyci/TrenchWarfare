    ...
    void Update()
    {
        ...
        if (Input.GetKey(KeyCode.Q))
        {
            if (Y_Timer <= 0)
            {
                ...
                Instantiate(M_Yakin, new Vector3(uretimNoktasi, 6f, randomZ), Quaternion.Euler(0f, 90f, 0f));
        ...
        if (Input.GetKey(KeyCode.W))
        {
            ...
            {
                float randomZ = Random.Range(-3f, 9f);
                Instantiate(M_Asker, new Vector3(uretimNoktasi, 6f, randomZ), Quaternion.Euler(0f, 90f, 0f));
        ...
        if (Input.GetKey(KeyCode.E))
        {
            ...
            {
                float randomZ = Random.Range(-3f, 9f);
                Instantiate(M_Tabanca, new Vector3(uretimNoktasi, 6f, randomZ), Quaternion.Euler(0f, 90f, 0f));
        ...
        if (Input.GetKey(KeyCode.R))
        {
            ...
            {
                float randomZ = Random.Range(-3f, 9f);
                Instantiate(M_Makineli, new Vector3(uretimNoktasi, 6f, randomZ), Quaternion.Euler(0f, 90f, 0f));
                AudioSource.PlayClipAtPoint(birlik_üretim_ses2, transform.position);
                Y_Timer = 11;
                A_Timer = 11;
                T_Timer = 16;
        ...
        if (Input.GetKey(KeyCode.T))
        {
            ...
            {
                float randomZ = Random.Range(-3f, 9f);
                Instantiate(M_Sniper, new Vector3(uretimNoktasi, 6f, randomZ), Quaternion.Euler(0f, 90f, 0f));
                AudioSource.PlayClipAtPoint(birlik_üretim_ses1, transform.position);
                Y_Timer = 11;
                A_Timer = 11;
                T_Timer = 16;
