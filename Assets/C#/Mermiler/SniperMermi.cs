...
public class SniperMermi : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider nesne)
    {
        if (nesne.gameObject.CompareTag("Mavi_Takim"))
        {
            ...
            if (m_Yakin != null)
            {
                m_Sniper.Askencan(10);
            }
            if (el_Bombacisi != null)
            {
                el_Bombacisi.Askencan(10);
            }
            if (tabancali != null)
            {
                tabancali.Askencan(10);
            }
        }
        else
        {
        ...
        if (nesne.gameObject.tag == "Kirmizi_Takim")
        {
            ...
            M_Sniper k_Sniper = nesne.gameObject.GetComponent<M_Sniper>();
            ...
            if (k_Sniper != null)
            {
                k_Sniper.Askencan(10);
            }
            if (k_el_Bombacisi != null)
            {
                k_el_Bombacisi.Askencan(10);
            }
            if (k_tabancali != null)
            {
                k_tabancali.Askencan(10);
            }
        }
        else
        {
