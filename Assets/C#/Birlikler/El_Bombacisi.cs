...
public class El_Bombacisi : MonoBehaviour
{
    //Konum
    ...
    private float M_bombaci_can = 10f;
    ...
    void Update()
    {
        ...
        //Olme
        if (M_bombaci_can <= 0 && anim.GetInteger("Hareket") == 0
            || M_bombaci_can <= 0 && anim.GetInteger("Hareket") == 2
            || M_bombaci_can <= 0 && anim.GetInteger("Hareket") == 7)
        {
            moveSpeed = 0f;
        ...
        if (mesafe <= 20)
        {
            ...
            if (timer >= 1.5f)
            {
                ...
                klon.GetComponent<Rigidbody>().AddForce(klon.up * 500f);
                timer = 0f;
            }
