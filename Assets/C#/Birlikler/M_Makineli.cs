...
public class M_Makineli : MonoBehaviour
{
    //Konum
    ...
    private float M_makinali_can = 30f;
    ...
    void Update()
    {
        ...
        //Olme
        if (M_makinali_can <= 0 && anim.GetInteger("Hareket") == 0
            || M_makinali_can <= 0 && anim.GetInteger("Hareket") == 2
            || M_makinali_can <= 0 && anim.GetInteger("Hareket") == 7)
        {
            moveSpeed = 0f;
