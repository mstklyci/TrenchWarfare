...
public class Tabancali : MonoBehaviour
{
    //Konum
    ...
    private float mesafe = 15f;
    private float Tabanca_can = 15f;
    ...
    void Update()
    {
        ...
        //Olme
        if (Tabanca_can <= 0 && anim.GetInteger("Hareket") == 0
            || Tabanca_can <= 0 && anim.GetInteger("Hareket") == 2
            || Tabanca_can <= 0 && anim.GetInteger("Hareket") == 7)
        {
            moveSpeed = 0f;
        ...
        else if (mesafe > 15 && anim.GetInteger("Hareket") == 6)
        {
            moveSpeed = 12f;
    ...
    private void OnTriggerStay(Collider nesne)
    {
        ...
        if (nesne.gameObject.tag == Siper1Tag)
        {
            ...
            //Devam
            else if (mesafe > 20 && anim.GetInteger("Hareket") == 4)
            {
                anim.SetInteger("Hareket", 5);
            }
            else
