...
public class M_Sniper : MonoBehaviour
{
    ...
    private float mesafe = 40f;
    private float M_sniper_can = 10f;
    ...
    void Update()
    {
        ...
        //Olme
        if (M_sniper_can <= 0 && anim.GetInteger("Hareket") == 0
            || M_sniper_can <= 0 && anim.GetInteger("Hareket") == 2
            || M_sniper_can <= 0 && anim.GetInteger("Hareket") == 7)
        {
            moveSpeed = 0f;
        ...
        if (mesafe <= 40)
        {
            ...
            if (timer >= 2.5f)
            {
                ...
                klon.GetComponent<Rigidbody>().AddForce(klon.forward * 1500f);
        ...
        else if (mesafe > 40 && anim.GetInteger("Hareket") == 6)
        {
            moveSpeed = 9f;
    ...
    private void OnTriggerStay(Collider nesne)
    {
        ...
        if (nesne.gameObject.tag == Siper1Tag)
        {
            ...
            //Devam
            else if (mesafe > 45 && anim.GetInteger("Hareket") == 4)
            {
                anim.SetInteger("Hareket", 5);
            }
            else
